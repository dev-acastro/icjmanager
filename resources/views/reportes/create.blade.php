                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('reporte.store')}}" id="ReportesForm">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="fecha" min="2021-03-01" max="2021-03-07" type="date" class="form-control @error('asistencia_adultos') is-invalid @enderror" name="fecha" value="{{ old('asistencia_adultos') }}" required autocomplete="asistencia_adultos" autofocus>
